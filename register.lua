...
source(Utils.getFilename("scripts/Events/SendUnloaderToUnloadEvent.lua", g_currentModDirectory))
...
source(Utils.getFilename("scripts/Manager/EscapeCourseGenerator.lua", g_currentModDirectory))
...
source(Utils.getFilename("scripts/Tasks/ClearHarvesterZoneTask.lua", g_currentModDirectory))
...
source(Utils.getFilename("scripts/Gui/SelectUnloaderGUI.lua", g_currentModDirectory))
